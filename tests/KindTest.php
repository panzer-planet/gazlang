...
class KindTest extends GazLangTestCase
{
    ...
    public function test_code_for_paths_through_fields()
    {
        $this->assertStringEndsWith(
            "POP\nPUSH 0\nKEY_CHECK\nPUSH 5\nSET_PATH [k].total 0\nPOP\nkind P\nLOAD_THIS\nRET\nfn P.f 0 0\nPUSH 1\nSET_PATH_THIS .items[]\nPOP\nPUSH null\nRET",
            $this->generateCode("kind P { #items; #total; fn f() { #items[] = 1; } }\n\$rows = [P()];\n\$rows[0].total = 5;")
        );
    }
    ...
    public function test_property_paths_interpolate_inside_braces()
    {
        $this->assertEquals("Hi W, you have 10 #fff \$a.owner.txt\n", $this->executeCode(<<<'CODE'
            kind Account { #owner = "W"; #balance = 10; }
            $a = Account();
    ...
    public function test_to_string_reads_and_writes_globals()
    {
        $this->assertEquals("g2 g3 3\n", $this->executeCode(<<<'CODE'
            @g = 1;
            kind G { fn to_string() { @g += 1; return "g{@g}"; } }
            echo G() .. " " .. G() .. " " .. @g;
            CODE));
    }
    ...
    {
        $code = 'kind Loop { fn to_string() { return "{#}"; } } echo Loop();';
        [$output, $exit_code] = self::cli([], $code);
    ...
    public function test_code_for_reading_fields()
    {
        ...
        $this->assertStringContainsString(
            ...
            $this->generateCode('kind P { #x = 1; #y; fn f() { return #x + (#y ?? 0) + (#x += 1) + 0 * len([#g]); } fn g() {} }')
        );
    }
    ...
    {
        return [
            'unset field' => ['kind P { #x; fn get() { return #x; } } echo P().get();', 'Property x of P is not set on line 14'],
            'unset field read with a dot' => ['kind P { #x; } echo P().x;', 'Property x of P is not set on line 14'],
            ...
            'unset field called, before the arguments' => ['kind P { #f; } P().f(error("args"));', 'Property f of P is not set on line 14'],
            ...
            'abstract kind through a builtin' => ['abstract kind S { abstract fn area(); } echo map([1], S);', 'Cannot construct abstract kind S on line 14'],
            'calling a field that is not a function' => ['kind P { #x = 1; } P().x();', 'Cannot call int on line 14'],
            ...
            'compound update of an unset field' => ['kind P { #x; } $p = P(); $p.x += 1;', 'Property x of P is not set on line 14'],
            'increment of an unset field with #' => ['kind P { #x; fn f() { #x++; } } P().f();', 'Property x of P is not set on line 14'],
            'through an unset field' => ['kind P { #x; } $p = P(); $p.x[0] = 1;', 'Property x of P is not set on line 14'],
            ...
            'to_string returning something else' => ['kind P { fn to_string() { return [1]; } } echo P();', 'P.to_string must return a string, got list on line 14'],
            'to_string returning something else, through ..' => ['kind P { fn to_string() { return null; } } $s = "a" .. P();', 'P.to_string must return a string, got null on line 14'],
    ...
    public static function syntaxErrors(): array
    {
        return [
            ...
            'dot after #' => ['kind P { fn f() { return #.name; } }', 'Write #name, not #.name on line 1'],
            ...
            'assigning to a method' => ['kind P { fn f() { #f = 1; } }', 'Cannot assign to method #f on line 1'],
            'the constructor as a member' => ['kind P { fn _() {} fn f() { #_(); } }', "Cannot use the constructor _ as a member: construct with P(...), or call ##_(...) in a child's constructor on line 1"],
            'duplicate field' => ["kind P {\n #x;\n #x = 1;\n}", 'P already has a field #x on line 3'],
            'duplicate method' => ['kind P { fn x() {} fn x() {} }', 'P already has a method x on line 1'],
            'method named like a field' => ['kind P { #x; fn x() {} }', "P already has a field #x, and a method can't have a field's name: call the method something else on line 1"],
            ...
            'local variable in a field default' => ["\$y = 1;\nkind P { #x = \$y; }", "The default of #x can't use \$y: fields have no local variables on line 2"],
            ...
            'method call arity' => ['kind P { fn f($a) { return #f(); } }', 'Method P.f expects 1 arguments, 0 given on line 1'],
            'assigning to a call' => ['kind P { #x; } fn make() { return P(); } make().x = 1;', 'Can only use = on a variable, or an element or field of one on line 1'],
            'assigning to #' => ['kind P { fn f() { # = 1; } }', 'Can only use = on a variable, or an element or field of one on line 1'],
            'incrementing a method' => ['kind P { fn f() { #f++; } }', 'Cannot assign to method #f on line 1'],
            ...
            'redeclared field' => ["kind A { #x; }\nkind B extends A {\n #x = 1;\n}", 'Field #x of B is already declared in A on line 3'],
            'field named like a parent method' => ['kind A { fn x() {} } kind B extends A { #x; }', 'Field #x of B has the name of a method of A: fields and methods share names, so call the field something else on line 1'],
            'method named like a parent field' => ['kind A { #x; } kind B extends A { fn x() {} }', 'Method B.x has the name of a field of A: fields and methods share names, so call the method something else on line 1'],
            'override with fewer arguments' => ["kind A { fn f(\$a, \$b = 1) {} }\nkind B extends A {\n fn f(\$a) {}\n}", 'Method B.f must accept every argument count A.f does (1 to 2) on line 3'],
            'override requiring more arguments' => ['kind A { fn f() {} } kind B extends A { fn f($a) {} }', 'Method B.f must accept every argument count A.f does (0) on line 1'],
            ...
            'abstract method with a body' => ['abstract kind A { abstract fn f() {} }', 'An abstract method has no body: end it with ; on line 1'],
            'abstract constructor' => ['abstract kind A { abstract fn _(); }', "A constructor can't be abstract on line 1"],
            'abstract method not defined' => ["abstract kind A { abstract fn f(); }\nkind B extends A {}", 'Kind B must define abstract method f of A, or be abstract on line 2'],
            'abstract method replacing a method' => ['kind A { fn f() {} } abstract kind B extends A { abstract fn f(); }', "Abstract method B.f can't replace A.f on line 1"],
            ...
            '## without a parent' => ['kind A { fn f() { return ##f(); } }', 'Cannot use ##f: A has no parent kind on line 1'],
            '## on a field' => ['kind A { #x; } kind B extends A { fn f() { return ##x; } }', '##x can only reach a method, and x is a field of A on line 1'],
            '## on an abstract method' => ['abstract kind A { abstract fn f(); } kind B extends A { fn f() { return ##f(); } }', 'Cannot use ##f: f is abstract in A on line 1'],
            '## on a missing method' => ['kind A {} kind B extends A { fn f() { return ##f(); } }', 'A has no method f on line 1'],
            '## arity' => ['kind A { fn f($a) {} } kind B extends A { fn f($a) { return ##f(); } }', 'Method A.f expects 1 arguments, 0 given on line 1'],
            '##_ outside a constructor' => ['kind A { fn _() {} } kind B extends A { fn f() { ##_(); } }', "##_ can only be used in a constructor, to run the parent's on line 1"],
            ...
            'to_string with only optional arguments is fine' => ['kind P { fn to_string($a = 1) { return ""; } } echo ;', "Unexpected ';' on line 1"],
            ...
            'duplicate method parameter' => ['kind P { fn f($a, $a) {} }', 'Duplicate parameter $a in method P.f on line 1'],
        ];
    }
    ...
    public function test_a_capitalised_keyword_can_name_a_kind_or_a_function()
    {
        ...
        $this->assertEquals("1\n", $this->executeCode('kind If { #x; fn _($x) { #x = $x; } } echo If(1).x;'));
        $this->assertEquals("2\n", $this->executeCode('fn Return($x) { return $x; } echo Return(2);'));
        $this->assertEquals("3\n", $this->executeCode('kind Match { fn While() { return 3; } } echo Match().While();'));
    }
    ...
    public static function declaredKeywordNames(): array
    {
        return [
            ...
            'a declared kind' => ['kind If { #x; fn _($x) { #x = $x; } } $y = If'],
            'a builtin' => ['$y = len'],
        ];
    }
}
